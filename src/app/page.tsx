            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-blue-50 p-6 rounded-xl">
                ...
                <p className="text-gray-600">
                  Nos chauffeurs professionnels vous attendent à l'heure, que ce soit pour un départ
                  ou une arrivée.
                </p>
              </div>
              <div className="bg-blue-50 p-6 rounded-xl">
                ...
                <p className="text-gray-600">
                  Des véhicules haut de gamme et des chauffeurs expérimentés pour un trajet
                  confortable.
                </p>
              </div>
              <div className="bg-blue-50 p-6 rounded-xl">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-3xl mx-auto space-y-6">
              <div className="bg-blue-50 p-6 rounded-xl">
                ...
                <p className="text-gray-600">
                  Il vous suffit de sélectionner votre point de départ, votre destination et la date
                  de votre trajet. Notre système vous proposera les meilleures options disponibles.
                </p>
              </div>
              <div className="bg-blue-50 p-6 rounded-xl">
                <h3 className="text-xl font-semibold text-gray-900 mb-2">
                ...
                <p className="text-gray-600">
                  Nous acceptons les cartes bancaires (Visa, Mastercard, American Express) et les
                  paiements par virement pour les entreprises.
                </p>
              </div>
              <div className="bg-blue-50 p-6 rounded-xl">
                <h3 className="text-xl font-semibold text-gray-900 mb-2">
                ...
                <p className="text-gray-600">
                  Oui, vous pouvez modifier ou annuler votre réservation jusqu'à 24h avant le
                  départ. Consultez nos conditions générales pour plus de détails.
                </p>
              </div>
            </div>
          </div>
